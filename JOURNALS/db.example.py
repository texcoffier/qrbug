...
failure_update("PC_NO_BOOT_OTHER", value="Autre chose ?", display_type=Textarea, ask_confirm=True, restricted_to_group_id="ROOT")
...
failure_update('SHOW_JOURNALS', value="Afficher les journeaux", display_type=Text, ask_confirm=True, restricted_to_group_id="ROOT")
failure_update('SHOW_JOURNALS_DB-DEFAULT_DB-INCIDENTS', value="Afficher TOUS les journeaux", display_type=Button, ask_confirm=True, restricted_to_group_id="ROOT")
failure_update('SHOW_JOURNALS_DB', value="Afficher la configuration", display_type=Button, ask_confirm=True, restricted_to_group_id="ROOT")
failure_update('SHOW_JOURNALS_DEFAULT_DB', value="Afficher la configuration par défaut", display_type=Button, ask_confirm=True, restricted_to_group_id="ROOT")
failure_update('SHOW_JOURNALS_INCIDENTS', value="Afficher la liste des incidents", display_type=Button, ask_confirm=True, restricted_to_group_id="ROOT")
