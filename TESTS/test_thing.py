...
class TestThing(qrbug.main.TestCase):
    def test_creation(self):
        ...
        self.check(qrbug.main.Thing, f'{ID} [] loc:None failure:None comment:\'\'')
    ...
    def test_update(self):
        ...
        self.check(qrbug.main.Thing, f"{ID} [] loc:None failure:None comment:'{new_value}'")
    ...
    def test_with_db(self):
        self.load_config()
        self.check(qrbug.main.Thing, f"0 [] loc:None failure:None comment:'A comment, it seems'")
