...
class TestThing(qrbug_main.TestCase):
    def test_creation(self):
        ...
        self.check(qrbug_main.Thing, f'{ID} [] {qrbug_main.Thing.__name__}()')
    ...
    def test_update(self):
        ...
        self.check(qrbug_main.Thing, f"{ID} [] {qrbug_main.Thing.__name__}(comment='{new_value}')")
    ...
    def test_with_db(self):
        self.load_config()
        self.check(qrbug_main.Thing, f"0 [] {qrbug_main.Thing.__name__}(comment='A comment, it seems')")
