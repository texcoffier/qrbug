...
class TestFailure(qrbug.TestCase):
    def test_creation(self):
        ...
        self.check(qrbug.Failure, f'0 [] val:\'VALEUR_NON_DEFINIE POUR «0»\' type:text confirm:False')
        ...
        self.check(qrbug.Failure, f"0 [] val:'{new_value}' type:text confirm:False")
    ...
    def test_parenting(self):
        ...
        self.check(qrbug.Failure, f'0 [] val:\'VALEUR_NON_DEFINIE POUR «0»\' type:text confirm:False\n'
                            f'1 [] val:\'VALEUR_NON_DEFINIE POUR «1»\' type:text confirm:False')

        # Parents 0 to 1 (adds 1 as the child of 0)
        qrbug.failure_add(a.id, b.id)
        self.check(qrbug.Failure, f"0 ['1'] val:\'VALEUR_NON_DEFINIE POUR «0»\' type:text confirm:False\n"
                            f'1 [] val:\'VALEUR_NON_DEFINIE POUR «1»\' type:text confirm:False')
    ...
    def test_with_db(self):
        ...
        self.check(qrbug.Failure, f"PC_NO_BOOT [] val:'Le PC ne démarre pas' type:text confirm:False")
