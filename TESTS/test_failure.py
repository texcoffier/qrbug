...
class TestFailure(qrbug.TestCase):
    ...
    def test_parenting(self):
        ...
        self.check(qrbug.Failure, f'0 [] val:\'VALEUR_NON_DEFINIE POUR «0»\' type:text confirm:False allowed:true\n'
                            f'1 [] val:\'VALEUR_NON_DEFINIE POUR «1»\' type:text confirm:False allowed:true')

        # Parents 0 to 1 (adds 1 as the child of 0)
        qrbug.failure_add(a.id, b.id)
        self.check(qrbug.Failure, f"0 ['1'] val:\'VALEUR_NON_DEFINIE POUR «0»\' type:text confirm:False allowed:true\n"
                            f'1 [] val:\'VALEUR_NON_DEFINIE POUR «1»\' type:text confirm:False allowed:true')
