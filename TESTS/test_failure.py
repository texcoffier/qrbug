...
class TestFailure(qrbug.TestCase):
    def test_creation(self):
        ...
        self.check(qrbug.Failure, f'0 [] val:\'VALEUR_NON_DEFINIE\' type:text confirm:True group:None')
    ...
    def test_parenting(self):
        ...
        self.check(qrbug.Failure, f"0 ['1'] val:\'VALEUR_NON_DEFINIE\' type:text confirm:True group:None\n"
                            f'1 [] val:\'VALEUR_NON_DEFINIE\' type:text confirm:True group:None')
